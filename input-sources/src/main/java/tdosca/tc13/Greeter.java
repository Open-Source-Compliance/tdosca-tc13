...
public class Greeter {
  ...
  public String speak(String garg) {
    ...
    System.out.println(inc+currentTime+": tdosca.tc13.Greeter(" + garg + "): 'hello'.");
    currentTime = new LocalTime();
    System.out.println(inc+currentTime+": license(Greeter,A.p.a.c.h.e-2.0)");
    tipster.speak();
    currentTime = new LocalTime();
    System.out.println(inc+currentTime+": tdosca.tc13.Greeter(...): 'bye bye'");
    return "back1";
  }
  public String speak() {
    currentTime = new LocalTime();
    System.out.println(inc+currentTime+": tdosca.tc13.Greeter(): 'hello'.");
    currentTime = new LocalTime();
    System.out.println(inc+currentTime+": license(Greeter,A.p.a.c.h.e-2.0)");
    tipster.speak();
    currentTime = new LocalTime();
